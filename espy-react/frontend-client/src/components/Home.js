    ...
    return(
        ...
        <div className="lg:w-1/3 sm:w-1/2 p-4">
                ...
                <div className="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                    <h2 className="tracking-widest text-sm title-font font-medium text-pink-500 mb-1">{props.subtitle}</h2>
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 pb-12  mx-auto">
                    ...
                    <div className="flex flex-wrap -m-4">
                        <Movie title={'Title'} subtitle={'Eng'} summary={'loremlorem lorem lorem loremlorem lorem lorem lorem lorem lorem lorem'} />
                        <Movie title={'Title'} subtitle={'Eng'} summary={'loremlorem lorem lorem loremlorem lorem lorem lorem lorem lorem lorem'} />
                        <Movie title={'Title'} subtitle={'Eng'} summary={'loremlorem lorem lorem loremlorem lorem lorem lorem lorem lorem lorem'} />
                        <Movie title={'Title'} subtitle={'Eng'} summary={'loremlorem lorem lorem loremlorem lorem lorem lorem lorem lorem lorem'} />
                        <Movie title={'Title'} subtitle={'Eng'} summary={'loremlorem lorem lorem loremlorem lorem lorem lorem lorem lorem lorem'} />
